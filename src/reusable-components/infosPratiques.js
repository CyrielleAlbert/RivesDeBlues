        ...
        <div>
            ...
            <div className="content-3">
                <div style={{ display: 'flex' }}>
                    <InfoSVG fill="#A90000" width={175} height={175} style={{ marginRight: 20, position: 'relative', top: -15 }} />
                ...
                <div style={{display:'flex'}}>
                    <WarningSVG fill="#A90000" width={50} height={50} style={{ marginRight: 20,position:"relative",top:20 }} />
